...
await Product.insertMany([
  ...
  await CollectibleDefinition.findOneAndUpdate(
    { slug: 'onboarding-achievement' },
    {
      $setOnInsert: {
        slug: 'onboarding-achievement',
        name: 'PADDOX Pioneer',
        description: 'Awarded to users who configure their team and driver preferences.',
  ...
  console.log('✅ Collectible definition seeded');
