...
const sendLoginTwoFactorHandler = ensureHandler('sendLoginTwoFactorCode', (req, res) => res.status(501).json({ success: false, message: 'Login 2FA send is not configured yet' }));
